...
export default function GetAFree() {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center min-h-fit py-32 md:h-screen md:py-0 -mt-40 md:-mt-80 space-y-16 overflow-hidden mb-32 md:-mb-50">
