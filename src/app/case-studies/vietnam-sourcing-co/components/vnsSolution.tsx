...
function ParallaxStrong({ src, alt, className, objectFit = "cover" }: { src: string; alt: string; className?: string; objectFit?: "cover" | "contain" }) {
    return (
        ...
        <div className="bg-white pb-16">
            <section className="container mx-auto px-6 mb-12">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-20">
                        <h3 className="generalsans-regular text-xl text-[#000A1D] mb-4">
                    ...
                    <div className="mb-20">
                        ...
                        <p className="generalsans-regular text-base leading-relaxed text-[#444444] mb-16">
