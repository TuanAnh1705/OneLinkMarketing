...
export default function HeroSection({ hero, whatsIncluded }: { hero?: SdHeroSection | null; whatsIncluded?: SdWhatsIncludedSection | null }) {
  const titleLine1 = hero?.titleLine1 || "SOCIAL MEDIA"
  const titleLine2 = hero?.titleLine2 ?? "MANAGEMENT"
  const description = hero?.description || "Transform your social channels into powerful community-building and lead-nurturing platforms through strategic content and authentic engagement."
  return (
