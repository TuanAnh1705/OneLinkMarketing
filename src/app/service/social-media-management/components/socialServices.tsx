...
const services: ServiceCardProps[] = [
  { title: <><br />Social Media Strategy<br />&amp; Planning</>, description: "Defining your audience, content pillars, and platform-specific goals to build a cohesive brand voice.", imageUrl: "/assets/25.png", link: "/case-studies" },
  { title: <><br />Content Creation &amp;<br />Scheduling</>, description: "Producing and scheduling engaging visuals, videos, and copy in a consistent content calendar.", imageUrl: "/assets/38.png", link: "/case-studies" },
  { title: <><br />Community Management<br />&amp; Engagement</>, description: "Actively engaging with your audience, responding to feedback, and fostering a loyal brand community.", imageUrl: "/assets/39.png", link: "/case-studies" },
  { title: <><br />Performance Analytics<br />&amp; Reporting</>, description: "Tracking key metrics, analyzing performance, and providing actionable reports to demonstrate ROI.", imageUrl: "/assets/40.png", link: "/case-studies" },
]
    ...
    <>
      ...
      <div className="hidden lg:block mb-12 md:-mb-18">
        <div className="relative h-[700px] xl:h-[800px] overflow-hidden shadow-lg w-full" onMouseLeave={() => setHoveredIndex(null)}>
          ...
          <MotionImage src={DEFAULT_SERVICE_IMAGE} alt="Social Media Services" fill className="object-cover" animate={{ opacity: 1 }} />
