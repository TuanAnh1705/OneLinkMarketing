...
export default function TestimonialsSection({ data }: { data?: SdCtaSection | null }) {
    const heading = data?.heading || "Start Your Strategic Journey"
    ...
    return (
        <section
            ref={sectionRef}
            className="relative bg-white text-[#000A1D] w-full overflow-hidden py-24 sm:py-32 -translate-y-60 md:-translate-y-20 z-10 md:mb-0 -mb-60"
        >
