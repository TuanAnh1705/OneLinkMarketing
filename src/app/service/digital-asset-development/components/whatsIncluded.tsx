...
const items = [
  {
    ...
    description: "Crafting a visual identity that is both professional and memorable.",
    link: "/case-studies",
  },
  {
    title: "Website Design",
    description: "Designing high-performance websites that are optimized for SEO and UX.",
    link: "/case-studies",
  },
  {
    title: "Landing Pages",
    description: "Creating targeted landing pages to convert visitors into leads efficiently.",
    link: "/case-studies",
  },
  {
    title: "Digital Collateral",
    description: "Producing assets like Ebooks and whitepapers to nurture leads.",
    link: "/case-studies",
  },
]
