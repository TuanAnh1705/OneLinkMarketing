...
const services: ServiceCardProps[] = [
  { title: <>Brand Identity</>, description: "Crafting a visual identity that is both professional and memorable.", imageUrl: "/assets/22.png", link: "/case-studies" },
  { title: <>Website Design</>, description: "Designing high-performance websites that are optimized for SEO and UX.", imageUrl: "/assets/29.png", link: "/case-studies" },
  { title: <>Landing Pages</>, description: "Creating targeted landing pages to convert visitors into leads efficiently.", imageUrl: "/assets/30.png", link: "/case-studies" },
  { title: <>Digital Collateral</>, description: "Producing assets like Ebooks and whitepapers to nurture leads.", imageUrl: "/assets/31.png", link: "/case-studies" },
]
const DEFAULT_SERVICE_IMAGE = "/assets/22.png"
    ...
    <>
      ...
      <div className="hidden lg:block mb-12 md:-mb-18">
        <div className="relative h-[700px] xl:h-[800px] overflow-hidden shadow-lg w-full" onMouseLeave={() => setHoveredIndex(null)}>
          ...
          <MotionImage src={DEFAULT_SERVICE_IMAGE} alt="Digital Asset Development Services" fill className="object-cover" animate={{ opacity: 1 }} />
